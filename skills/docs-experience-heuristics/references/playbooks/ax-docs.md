...
- `references/playbooks/api-contracts.md` — machine-readable schemas, tool
  descriptions, errors, and retries.
- `references/playbooks/audience-conflicts.md` — resolving human/agent doc
  tension.
- `references/playbooks/foundations.md` — IA, versioning, and docs-as-code gates.
- `references/core/audience-matrix.md` — AX-only requirements and transfer rules.
