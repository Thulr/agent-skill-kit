...
- `references/docs/playbooks/dx-docs.md` — human API reference, quickstarts, and
  examples.
- `references/docs/playbooks/audience-conflicts.md` — when polished human docs conflict
  with generated or schema-derived docs.
- `references/docs/core/severity-rubric.md` — duplicate side effects and unsafe retries
