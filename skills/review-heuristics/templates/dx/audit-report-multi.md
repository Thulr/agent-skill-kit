...
## First impressions
- Score: <passed> / <applicable> (from `references/dx/first-impressions-checklist.md`;
...
- **How the cap interacts with per-surface scores:** the 7/10 cap from the
  ...
  `references/dx/first-impressions-checklist.md`). If the project rolls up to
...
Lowest → highest. Score from `references/dx/core/score-rubric.md`.
