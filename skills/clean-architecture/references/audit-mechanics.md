...
The default output template comes from `references/intent-router.csv`:

- audit -> `templates/audit-report.md`
- design -> `templates/design-doc.md`
- refactor -> `templates/refactor-runbook.md`
- explain -> `templates/explanation.md`

For `audit/all`, use `templates/audit-report-multi.md`. Do not write
