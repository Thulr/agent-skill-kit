...
python3 "$repo_root/scripts/check-skill-static.py" \
  ...
  --require-file templates/diagnose-runbook.md \
  ...
  --require-pattern 'routes design elsewhere::SKILL.md::perf-design' \
  --require-pattern 'audit report forbids mere offer::templates/audit-report.md::offer or inline tracking' \
  --require-pattern 'audit report preserves fallback path::templates/audit-report.md::audit-artifacts/perf-audit-' \
