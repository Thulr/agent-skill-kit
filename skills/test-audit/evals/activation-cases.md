...
```bash
bash skills/test-audit/evals/run-static-checks.sh
```
...
agent: activates for realistic test-audit prompts; asks at most one blocker
...
**Prompt:** `Verify whether TEST-unit-002 is fixed in this PR using docs/audits/test-audit-workflow-state-2026-05-20-unit.json.`
...
**Expected:** recognizes a DX surface, not a test suite; defers (dx-audit).
