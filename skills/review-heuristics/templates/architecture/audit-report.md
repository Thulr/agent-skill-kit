...
**Playbook applied:** `references/architecture/playbooks/<surface>.md`
**Score:** <0–10 from references/architecture/core/score-rubric.md> — <Exemplary / Healthy / Mixed / Eroded / Inverted / Absent>
**Date:** <YYYY-MM-DD>
...
tracking artifacts now: the Markdown ledger from `templates/architecture/findings-ledger.md`
at
