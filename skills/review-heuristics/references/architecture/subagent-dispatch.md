...
Read references/architecture/playbooks/<surface>.md and references/architecture/core/severity-rubric.md
and references/architecture/core/glossary.md before starting.

Agent 2 (boundary-designer): <Lens 2 prompt above>, applied to <surface>.
Read references/architecture/playbooks/<surface>.md, references/architecture/core/severity-rubric.md,
and references/architecture/core/glossary.md before starting.

Agent 3 (refactor-pragmatist): <Lens 3 prompt above>, applied to
<surface>. Read references/architecture/playbooks/<surface>.md and
references/architecture/core/severity-rubric.md before starting. Runs independently
...
5. **Map to template.** Emit the intent-appropriate template —
   ...
   `references/architecture/intent-router.csv`'s `default_template` column) —
...
`references/architecture/intents/audit.csv` (excluding the `all` row itself). Each
...
`templates/architecture/audit-report-multi.md`. Do not hardcode the surface set in
