...
Applied to every finding in `harden`, `scaffold`, `diagnose`, and to each gap in `assess`. Shares the 0–4 scale with `skills/dx-heuristics/references/core/severity-rubric.md`; adapted to agent-specific failure language.
