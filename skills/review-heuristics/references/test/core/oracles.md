...
- `references/test/layers/exploratory.md` — exploratory sessions should pick an oracle and drive variation along it
- `references/test/subagent-dispatch.md` — the bug-shape hunter lens uses these oracles to imagine bugs the existing suite misses
