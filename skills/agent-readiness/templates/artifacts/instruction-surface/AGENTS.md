<!-- AGENTS.md template — informed-skills / agent-readiness scaffold.
     ...
     `agent-rules`), rules in this AGENTS.md can cite
...
<!-- Each rule is project-specific and verifiable. Number rules so
     ...
     `agent-rules`, rules can optionally cite the
...
<!-- Reflection-log workflow is optional. If this project keeps a
     ...
     `agent-rules` and use its `capture` / `promote`
...
<!-- If the project keeps a reflection log per `agent-rules`,
     cite it here: -->
