...
- `references/agent-friendly-architecture.md` — shared note on repo structure graphs + boundary enforcement; points to `review-heuristics` (architecture domain) for boundary design.
