...
|---|---|---|
| Legibility | <N> | <single line; cite weakest surface; no `|`> |
...
`docs/audits/harden-repo-for-coding-agents-findings-ledger-<YYYY-MM-DD>-<scope-slug>.md`
and the workflow state from `templates/workflow-state.json` at
`docs/audits/harden-repo-for-coding-agents-workflow-state-<YYYY-MM-DD>-<scope-slug>.json`.
Create the directory if needed. If the target is not a repo or `docs/audits/`
is not writable, use matching `audit-artifacts/harden-repo-for-coding-agents-...`
