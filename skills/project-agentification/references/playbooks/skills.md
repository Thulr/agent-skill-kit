...
- **Do not autogenerate skills from boilerplate (W9).** Bootstrap from a specific repeated manual
  ...
  pattern via `evidence-driven-agent-rules` — optional, not required.)
...
- **informed-skills/skills/dx-critique/** — local reference for the SKILL.md shape in this
...
- "Evaluating AGENTS.md: Are Repository-Level Context Files Helpful for Coding Agents?" —
  ...
  W1 (≥3 floor) in `evidence-driven-agent-rules`.
