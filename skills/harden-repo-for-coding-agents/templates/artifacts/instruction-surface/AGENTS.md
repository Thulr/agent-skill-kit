<!-- AGENTS.md template — informed-skills / harden-repo-for-coding-agents scaffold.
     ...
     `rules-from-coding-agent-failures`), rules in this AGENTS.md can cite
...
<!-- Each rule is project-specific and verifiable. Number rules so
     ...
     `rules-from-coding-agent-failures`, rules can optionally cite the
...
<!-- Reflection-log workflow is optional. If this project keeps a
     ...
     `rules-from-coding-agent-failures` and use its `capture` / `promote`
...
<!-- If the project keeps a reflection log per `rules-from-coding-agent-failures`,
     cite it here: -->
